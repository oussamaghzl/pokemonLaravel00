...
@section('content')
    ...
    <form action="/modification-pokemon/{{$pokemon->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container bg-white px-5 py-4 mt-5">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{$pokemon->nom}}" class="form-control" id="inputCity" name="nom">
                </div>
                
                <div class="form-group col-md-6">
                    <label for="inputCity">Niveau</label>
                    <input type="number" value="{{$pokemon->niveau}}" class="form-control" id="inputCity" name="niveau">
                </div>
            ...
            <div class="form-row">
                ...
                <select id="inputState" class="form-control" value="{{$pokemon->type_id}}" name="type_id">
